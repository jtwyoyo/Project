...
public class BankTester {
	...
	public static void main(String[] args) {
	    ...
	    str1 = in.nextLine();
	    System.out.println("Enter a word or phrase to check if it is a palindrome: "+str1+"");
	    in.close();
	    ...
	    {
	    if (str1.equals(str2))
	      System.out.println("The input phrase \""+str1+"\" is a palindrome");
	    else
	      System.out.println("The input phrase \""+str1+"\" is not a palindrome");
	    }
	    
	    if(x == false)
	    {
	    	if (str1.equals(str2))
	  	      System.out.println("The input word \""+str1+"\" is a palindrome");
	  	    else
	  	      System.out.println("The input word \""+str1+"\" is not a palindrome");
	    }
	}
